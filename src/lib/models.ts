...
// Imported by BOTH the browser client (Settings UI) and the server
// (provider resolution). Keep this file free of any Node- or browser-only
// APIs so it can be bundled by Vite and by the Vercel function alike.
